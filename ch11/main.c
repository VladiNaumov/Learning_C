...
Если сравнивать с главной	функцией в примере	ch10, то	мы	не	подключили	пу-
бличный	интерфейс	класса	Person.	Нам	также пришлось использовать поведенческие
функции	класса	Student, поскольку	указатели	student_t и	person_t больше не взаимо заменяемы.
