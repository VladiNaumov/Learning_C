...
/*
    В главной функции подключаются публичные интерфейсы обоих классов, Person и Student (но не приватный заголовочный файл),
    но создается только объект student. Как видите, этот объект унаследовал все атрибуты своего внутреннего объекта person,
    и для их чтения может использовать поведенческие функции класса Person.
*/