...
/*
    Если сравнивать с главной функцией в примере ch10, то мы не подключили публичный интерфейс класса Person.
    Нам также пришлось использовать поведенческие функции класса Student,
